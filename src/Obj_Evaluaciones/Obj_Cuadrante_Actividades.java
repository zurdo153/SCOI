...
public class Obj_Cuadrante_Actividades {
	...
	public Obj_Cuadrante_Actividades(){
	...
	public boolean guardar(int folio, int cuadrante, String encargado, String[][] tabla){ 
		return new GuardarTablasModel().Guardar_Cuadrante_Tabla_Real(folio, cuadrante, encargado, tabla);
	}
	
	public String[][] tabla(int folio) throws SQLException{
		return new BuscarSQL().getTablaActividadesCuadrante(folio);
	}
