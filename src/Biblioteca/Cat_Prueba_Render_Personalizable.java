...
//	static Object[][] cortes_guardados = new BuscarTablasModel().filtro_impuntualidad_a_considerar();
	...
	public Cat_Prueba_Render_Personalizable(){
	...
	public void cargar_fechas(){
		...
		Color colorFilaPar 			= Color.yellow;
		Color colorFilaNon 			= Color.white;
...
//		Color colorFilaPar 			= new java.awt.Color(1,2,3);
//		Color colorFilaNon 			= Color.white;
//		Color colorTexto 			= Color.white;
//		Color colorSeleccionFila 	= Color.blue;//new java.awt.Color(186,143,73);
//		Color colorSeleccionChb 	= Color.RED;
...
//							System.out.println("aqui es igual a = "+realizo_consideracion);
	...
	public static void main(String[] args) {
		try{
			...
			new Cat_Prueba_Render_Personalizable().setVisible(true);
		}catch(Exception e){
