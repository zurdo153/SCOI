...
//	}
	...
	public boolean guardar(Object[][] tb_asignaciones,Object[][] tb_vauchers,Object[][] tb_totales_por_fecha){
			return new GuardarSQL().Guardar_Corte(this, tb_asignaciones, tb_vauchers, tb_totales_por_fecha); 
	}
