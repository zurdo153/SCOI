...
public class Cat_Seguimiento_De_Servicios extends JFrame{
	...
	public void init_tabla(){
		...
		String comando="sp_select_seguimiento_a_servicios_pendientes '"+Departamento+"'";
	...
	String[] status = {"SOLICITADO","EN PROCESO","TERMINADO","CANCELADO"};
...
//		this.setSize(ancho,alto);
		...
		this.panel.add(txtFcActual).setBounds                (x+=605  ,y      ,width    ,height   );
		x=15;
