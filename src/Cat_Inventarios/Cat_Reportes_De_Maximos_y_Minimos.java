...
public class Cat_Reportes_De_Maximos_y_Minimos extends JFrame{
	...
	String operador[] = {"Selecciona Un Reporte","Reporte De Pedido Sugerido De Maximos y Minimos Del Establecimiento", "Reporte De Maximos y Minimos Del Establecimiento","Reporte De Exceso De Acuerdo A Los Maximos Del Establecimiento" };
	...
	public static void main(String args[]){
		try{
			...
			new Cat_Reportes_De_Maximos_y_Minimos().setVisible(true);
		}catch(Exception e){	}
	}
}
