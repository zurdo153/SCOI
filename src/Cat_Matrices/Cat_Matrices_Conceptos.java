...
public class Cat_Matrices_Conceptos extends JFrame{
...
//	String cat = "MATRICES_UNIDAD_DE_INSPECCION";
	...
	public void init_tablaf(){
		...
		String comandof="select folio,concepto,abreviatura,case when status='V' then 'Vigente' else 'Cancelado' end as estatus,convert(varchar(20),ultima_modificacion,103)+' '+convert(varchar(20),ultima_modificacion,108) as ultima_modificacion from matrices_conceptos";
	...
	JTextField txtAbreviatura   = new Componentes().text(new JCTextField(), "Abreviatura", 15, "String");
	...
	public Cat_Matrices_Conceptos(){
		...
		this.setTitle("Matrices Conceptos");
		this.panel.setBorder(BorderFactory.createTitledBorder("Conceptos"));
	...
	public static void main(String args[]){
		try{UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
			new Cat_Matrices_Conceptos().setVisible(true);
