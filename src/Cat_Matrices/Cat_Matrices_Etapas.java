...
public class Cat_Matrices_Etapas extends JFrame{
...
//	String cat = "MATRICES_UNIDAD_DE_INSPECCION";
	...
	public void init_tablaf(){
		...
		String comandof="select folio,etapa,abreviatura,case when status='V' then 'Vigente' else 'Cancelado' end as estatus,convert(varchar(20),ultima_modificacion,103)+' '+convert(varchar(20),ultima_modificacion,108) as ultima_modificacion from matrices_etapas";
	...
	public Cat_Matrices_Etapas(){
		...
		this.setTitle("Matrices Etapas");
		this.panel.setBorder(BorderFactory.createTitledBorder("Etapas"));
	...
	public static void main(String args[]){
		try{UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
			new Cat_Matrices_Etapas().setVisible(true);
