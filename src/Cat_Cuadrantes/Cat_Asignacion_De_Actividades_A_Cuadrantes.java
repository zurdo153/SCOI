...
public class Cat_Asignacion_De_Actividades_A_Cuadrantes extends JFrame{
	...
	public Cat_Asignacion_De_Actividades_A_Cuadrantes(){
...
//////////////////////////////////////////////////////////TODO Ventana De Seleccion Del Usuario/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public class Cat_Seleccion_Del_Usuario extends JDialog{
		...
		public void init_tablafu(){
			...
			this.tablaus.getColumnModel().getColumn(1).setMinWidth(280);
			...
			if(!(usuarios.getUsuarios_nombres()==null)){
			  ...
			  String comandob="exec cuadrantes_actividades_asignacion_filtro_empleado_general ";
			  ObjTab.Obj_Refrescar(tablaus,modelous, columnasb, comandob, basedatos,pintar,checkbox);
			}
	    }
...
//			Duracion
	...
	public static void main(String[] args) {
		try{
			...
			new Cat_Asignacion_De_Actividades_A_Cuadrantes().setVisible(true);
		}catch(Exception e){	}	
	}
}
