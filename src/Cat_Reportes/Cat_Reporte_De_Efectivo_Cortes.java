...
public class Cat_Reporte_De_Efectivo_Cortes extends JFrame {

	@SuppressWarnings({ "rawtypes", "unchecked" })
	public Cat_Reporte_De_Efectivo_Cortes(String folio_corte) {
			
			String query_efectivo = "exec sp_select_reporte_efectivo_para_cortes '"+folio_corte+"';";
...
//			efectivo
			...
			JasperReport report_efectivo = JasperCompileManager.compileReport(System.getProperty("user.dir")+"\\src\\Obj_Reportes\\Obj_Reporte_De_Efectivo_Para_Cortes.jrxml");
