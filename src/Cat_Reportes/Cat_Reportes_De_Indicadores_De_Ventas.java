...
public class Cat_Reportes_De_Indicadores_De_Ventas extends JFrame {
	...
	String operador[] = {"Selecciona Un Reporte","Reporte Indicador De Nivel De Surtido"};
	...
	public Cat_Reportes_De_Indicadores_De_Ventas(){
		this.setSize(430,250);
		this.setResizable(false);
		
		this.setLocationRelativeTo(null);
		this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
		this.setTitle("Indicadore De Ventas");
		...
		x=20;width=380;
		this.panel.add(cmbEstablecimiento).setBounds          (x     ,y+=35  ,width   ,height   );
...
//	};
	...
	public static void main(String args[]){
		try{
			...
			new Cat_Reportes_De_Indicadores_De_Ventas().setVisible(true);
		}catch(Exception e){	}
	}
