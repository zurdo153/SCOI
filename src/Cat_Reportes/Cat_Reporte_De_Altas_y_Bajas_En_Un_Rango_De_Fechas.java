...
public class Cat_Reporte_De_Altas_y_Bajas_En_Un_Rango_De_Fechas extends JFrame {
	...
	JButton btn_generar_altas = new JButton  ("Reporte de Altas",new ImageIcon("imagen/vigente16.png"));
	...
	public Cat_Reporte_De_Altas_y_Bajas_En_Un_Rango_De_Fechas(){
		...
		this.panel.add(new JLabel("Departamento:")).setBounds(220,55,150,20);
		this.panel.add(JLBdepartamento).setBounds(300,55,20,20);
		this.panel.add(cmbDepartamento).setBounds(320,55,170,20);
	
		this.panel.add(btn_generar_altas).setBounds(80,100,150,25);
		...
		public void actionPerformed(ActionEvent e) {
			if(validar_fechas().equals("")){
				...
				if(c_inicio.getDate().before(c_final.getDate())){
					Reporte_de_mov(fecha_inicio,fecha_final,Establecimiento,Departamento,e.getActionCommand().equals("Reporte de Altas")?"altas":"bajas");
				}else{
	...
	public void Reporte_de_mov(String fecha_inicio, String fecha_final,String Establecimiento,String Departamento,String mov){
		 reporte = "Obj_Reporte_De_Empleado_Mov_Altas_Bajas.jrxml";
		 
		 comando = "exec sp_Reporte_De_Altas_y_Bajas_De_Personal '"+fecha_inicio+"','"+fecha_final+"','"+Establecimiento+"','"+Departamento+"','"+mov+"'";
