	...
	ActionListener opGuardar = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if(!txtFolio.getText().equals("")){
				...
				if(new ActualizarSQL().Autorizar_DPR(Integer.valueOf(txtFolio.getText().trim()), "A", txaObservacion.getText().toString().trim().toUpperCase())){//V= Elaborado  R= Revisado  A= Autorizaado  N= Negar
