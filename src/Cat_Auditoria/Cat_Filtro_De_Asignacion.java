...
//		String todos = "exec sp_Reporte_IZAGAR_de_Asignaciones_del_dia";
		...
		String todos = "declare @fecha_inicial varchar(50),@fecha_final varchar(50) " +
				...
				"      ,ISNULL(convert(varchar(20),Asignaciones_cajeros.fecha_liquidacion,103),'')+' '+convert(varchar(20), Asignaciones_cajeros.fecha_liquidacion,108) as Fecha_Liquidacion " +
//				"	  ,valores_por_tasa_temp.tasa as tasa " +
//				"	  ,valores_por_tasa_temp.importe as importe " +
//				"	  ,valores_por_tasa_temp.iva as iva " +
//				"	  ,valores_por_tasa_temp.ieps as ieps" +
...
//				"	  INNER JOIN valores_por_tasa_temp ON Asignaciones_cajeros.folio = valores_por_tasa_temp.asignacion " +
				"		WHERE " +
...
//				"				 ,valores_por_tasa_temp.tasa ,valores_por_tasa_temp.importe, valores_por_tasa_temp.iva, valores_por_tasa_temp.ieps " +
