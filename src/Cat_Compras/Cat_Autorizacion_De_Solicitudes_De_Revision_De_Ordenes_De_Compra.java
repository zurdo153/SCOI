...
public class Cat_Autorizacion_De_Solicitudes_De_Revision_De_Ordenes_De_Compra extends JFrame{
	...
	public void init_tablaordenes(){
    	...
    	this.tablafilordenes.getColumnModel().getColumn(1).setMinWidth (100);		
    	...
    	this.tablafilordenes.getColumnModel().getColumn(4).setMinWidth (90 );
    	...
    	this.tablafilordenes.getColumnModel().getColumn(8).setMinWidth (250);
    	this.tablafilordenes.getColumnModel().getColumn(9).setMinWidth (90 );
    	this.tablafilordenes.getColumnModel().getColumn(10).setMinWidth(90 );
    	this.tablafilordenes.getColumnModel().getColumn(11).setMinWidth(90 );
    	...
    	this.tablafilordenes.getColumnModel().getColumn(14).setMinWidth(350);
    	
		String comandof="exec orden_de_compra_filtro_solicitudes_revision_autorizacion ";
	...
	public DefaultTableModel modeloor_filtro = new DefaultTableModel(null, new String[]{"Folio Orden","Establecimiento","Razon","Estatus Solicitud","Estatus Tiempo","Proveedor","Fecha Orden","Elaboro","Solicito Revision","Total","Condicion Pago","Plazo", "Fecha Expiracion", "Cantidad  Prod.","Notas","Cod. Proveedor"}){
		 @SuppressWarnings("rawtypes")
			Class[] types = baseOr();
...
//	JTable tablafilordenes = new JTable(modeloor_filtro);
	  ...
	  JTable tablafilordenes = new JTable(modeloor_filtro){
	     	 public Component prepareRenderer(TableCellRenderer renderer, int row, int col) {
	     	        ...
	     	        if(col==3){
	     	        	 Color c = Color.RED;
	                  if(tablafilordenes.getValueAt(row,3).toString().trim().equals("AUTORIZADA")) {   
	...
	public Cat_Autorizacion_De_Solicitudes_De_Revision_De_Ordenes_De_Compra(){
		this.setTitle("Revisión De Solicitudes De Autorizacion De Ordenes De Compra");
		this.setSize(1024,625);
    	...
    	public class Cat_Filtro_Detalle_Orden_de_Compra extends JDialog{
    		...
    		Obj_tabla ObjTab =new Obj_tabla();
    			...
    			public void init_tablafp2(String Folio_ordencompra){
    		    	...
    		    	this.tablafp2.getColumnModel().getColumn(16).setMinWidth(200);
    			...
    			public DefaultTableModel modelof2 = new DefaultTableModel(null, new String[]{"Codigo","Descripcion","Cantidad","Precio Orden Compra","Costo Promedio","Precio Venta", "Margen" ,"M.Familia","Precios Por Volumen","Descuentos","Descuento", "Existencia","Venta Ultimos 90 Dias", "Importe Compra","Razon","Observaciones","Observaciones Autorizo","Ultimo Costo"}){
    				 @SuppressWarnings("rawtypes")
    					Class[] types = base2();
    					@SuppressWarnings({ "rawtypes", "unchecked" })
    					public Class getColumnClass(int columnIndex) {return types[columnIndex]; }
    					public boolean isCellEditable(int fila, int columna){ if(columna>15 && columna<17) {return true;}else{return false;}     }
    			};
    		...
    		@SuppressWarnings({ "rawtypes", "unchecked" })
    		public Cat_Filtro_Detalle_Orden_de_Compra(String folio ,String Establecimiento ,String Cod_Prov ,String Nombre_Proveedor ,String Fecha_Elaboracion ,String Elaboro ,String Total ,String Condicion ,String Plazo,String Fecha_Expira,String Notas){
      		...
      		ActionListener op_autorizar = new ActionListener() {
    			...
    			public void actionPerformed(ActionEvent e) {
    	    	   ...
    	    	   orden_de_compra.setGuardarActualizar("A");
			    ...
			    tbl.addMouseListener(new java.awt.event.MouseAdapter() {
					...
					public void mousePressed(MouseEvent e) {
			        	if(e.getClickCount()!=0){
	                         if(tbl.getSelectedColumn()==13){
	                    	        tbl.getColumnModel().getColumn(13).setCellEditor(new javax.swing.DefaultCellEditor(cmbRazon));
...
//    					}
	...
	public static void main(String[] args) {
		try{
			...
			new Cat_Autorizacion_De_Solicitudes_De_Revision_De_Ordenes_De_Compra().setVisible(true);
		}catch(Exception e){	}
	}
}
