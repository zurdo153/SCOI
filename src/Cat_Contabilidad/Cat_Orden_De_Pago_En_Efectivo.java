...
public class Cat_Orden_De_Pago_En_Efectivo extends JFrame{
	...
	JButton btnBuscar = new JButton(new ImageIcon("imagen/tarjeta-de-informacion-del-usuario-icono-7370-16.png"));
	...
	public Cat_Orden_De_Pago_En_Efectivo(){
		...
		this.setTitle("Orden De Pago En Efectovo");
		panel.setBorder(BorderFactory.createTitledBorder("Realizar Orden De Pago"));
		...
		panel.add(txtFolio).setBounds(65,y,90,20);
		
		panel.add(new JLabel("Cantidad:  $")).setBounds(15,y+=25,70,20);
		panel.add(txtCantidad).setBounds(95,y,90,20);
		
		panel.add(new JLabel("Fecha:")).setBounds(210,y,70,20);
		panel.add(fhFecha  ).setBounds(260,y,90,20);
		...
		panel.add(cmbAutorizados).setBounds(95,y,190,20);
		...
		panel.add(btnGuardar).setBounds(295,y+=30,100,20);
...
//						Obj_Usuario usuario = new Obj_Usuario().LeerSession();
						...
						String comando="exec sp_select_orden_de_pago_en_efectivo "+Integer.valueOf(txtFolio.getText()) ;
