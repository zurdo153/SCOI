...
public class BORRAR_Cat_Tipo_De_Bancos extends JFrame{
	...
	JTextField txtBanco = new Componentes().text(new JTextField(), "Nombre", 100, "String");
	...
	public BORRAR_Cat_Tipo_De_Bancos(){
		
		this.setIconImage(Toolkit.getDefaultToolkit().getImage("Imagen/Company.png"));
		panel.setBorder(BorderFactory.createTitledBorder("Tipo de Bancos"));
		
		this.setTitle("Tipo de Bancos");
		...
		panel.add(new JLabel("Banco:")).setBounds(x,y+=30,ancho,20);
		panel.add(txtBanco).setBounds(ancho-20,y,ancho+ancho,20);
	...
	private JScrollPane getPanelTabla()	{		
		...
		try {
			...
			rs = s.executeQuery("select folio,"+
					...
					"  from tb_tipo_banco where status=1");
			...
			public void mouseClicked(MouseEvent e) {
	        	if(e.getClickCount()==1){
	        		...
	        		int id = Integer.parseInt(modelo.getValueAt(fila,0)+"");
						...
						Obj_Tipo_De_Bancos fuente_sodas = new Obj_Tipo_De_Bancos().buscar(id);
						
						txtFolio.setText(id+"");
						txtBanco.setText(modelo.getValueAt(fila,1)+"");
	...
	ActionListener guardar = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			if(txtFolio.getText().equals("")){
				...
				Obj_Tipo_De_Bancos puesto = new Obj_Tipo_De_Bancos().buscar(Integer.parseInt(txtFolio.getText()));
				...
				if(puesto.getFolio() == Integer.parseInt(txtFolio.getText())){
					if(JOptionPane.showConfirmDialog(null, "El registro ya existe, ¿desea cambiarlo?") == 0){
						if(validaCampos()!="") {
							...
							puesto.setBanco(txtBanco.getText());
							...
							modelo.setValueAt(txtBanco.getText(),nroFila,1);
	...
	private String validaCampos(){
		String error="";
		if(txtBanco.getText().equals("")) 			error+= "Banco\n";
	...
	ActionListener nuevo = new ActionListener(){
		public void actionPerformed(ActionEvent e) {
			Obj_Tipo_De_Bancos puesto = new Obj_Tipo_De_Bancos().buscar_nuevo();
			if(puesto.getFolio() != 0){
				panelLimpiar();
				panelEnabledTrue();
