...
public class Cat_Fue_Sodas_AUXF extends JFrame {
	...
	public Cat_Fue_Sodas_AUXF(String algo) {
        ...
        tbl.addMouseListener(new java.awt.event.MouseAdapter() {
	        public void mouseClicked(MouseEvent e) {
	        	if(e.getClickCount()==1){
	        		...
	        		try {
						Obj_Fue_Sodas_AUXF fuente_sodas = new Obj_Fue_Sodas_AUXF().buscar(id);
	...
	ActionListener guardar = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			...
			if(validaCampos()!="") {
				...
				int nroFila = tabla.getSelectedRow();
				if(cantidadFilasSeleccionadas == 0){
					Obj_Fue_Sodas_AUXF fsauxf = new Obj_Fue_Sodas_AUXF();
					...
					fsauxf.setFecha(new SimpleDateFormat("dd/MM/yyyy").format(txtCalendario.getDate()));
					fsauxf.guardar();
					
					Object[] fila = new Object[tabla.getColumnCount()]; 
					try {
						Obj_Fue_Sodas_AUXF maximo = new Obj_Fue_Sodas_AUXF().maximo();
	...
	ActionListener filtro = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			dispose();
			new Cat_Captura_Y_Modificacion_De_Fuente_De_Sodas_AUXF().setVisible(true);
