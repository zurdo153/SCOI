...
//						tabla.editingStopped(null);
	...
	KeyListener op_filtro = new KeyListener(){
		public void keyReleased(KeyEvent arg0) {
			new Obj_Filtro_Dinamico(tabla,"Folio", txtFolio.getText().toString().trim(), "Nombre Completo", txtNombre_Completo.getText().toUpperCase(),"Establecimiento",cmbEstablecimientos.getSelectedItem()+"", "", "");
		}
		public void keyTyped(KeyEvent arg0) {
		}
		public void keyPressed(KeyEvent arg0) {}
